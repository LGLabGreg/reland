...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded font-semibold transition-all border border-transparent',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-primary/90',
        outline:
          'bg-background text-foreground border border-foreground hover:bg-primary/90 hover:text-primary-foreground',
